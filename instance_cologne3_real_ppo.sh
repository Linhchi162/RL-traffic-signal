#!/bin/bash
# instance_cologne3_real_ppo.sh
# Train PPO tren Cologne3 voi luu luong THAT tu RESCO benchmark (cologne3.rou.xml)
#
...
#
# Usage: cd /workspace/rl-traffic && bash instance_cologne3_real_ppo.sh
...
OK=$((TOTAL - FAIL))
echo "=========================================="
echo "  cologne3-real-PPO done: $OK/$TOTAL OK"
echo "  Models: $EXP_DIR/"
echo "=========================================="
