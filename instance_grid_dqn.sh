#!/bin/bash
# instance_grid_dqn.sh — Train 24 grid-DQN jobs (8 seeds × 3 rewards) on one Vast.ai instance
# Multi-agent IPPO-style DQN: 4 junctions, shared weights, MultiAgentVecEnv
...
TOTAL=${#ALL_PIDS[@]}
echo ""
echo "  $TOTAL grid-DQN jobs running. Logs: $LOG_DIR/"
echo ""
...
OK=$((TOTAL - FAIL))
echo "=========================================="
echo "  grid-DQN done: $OK/$TOTAL OK"
echo "=========================================="
