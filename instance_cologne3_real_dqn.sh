#!/bin/bash
# instance_cologne3_real_dqn.sh
# Train DQN tren Cologne3 voi luu luong THAT tu RESCO benchmark (cologne3.rou.xml)
#
# Route file: du lieu thuc te o Cologne (TAPAS Cologne), 1 gio (0-3600s)
# sim_duration = 3600 | total_steps = 500000
#
# 8 seeds x 3 reward = 24 jobs chay song song
#
# Usage: cd /workspace/rl-traffic && bash instance_cologne3_real_dqn.sh
...
LOG_DIR="./logs_cologne3_real_dqn"
STEPS=500000
SIM_DUR=3600
SUMO_BEGIN=25200
...
OK=$((TOTAL - FAIL))
echo "=========================================="
echo "  cologne3-real-DQN done: $OK/$TOTAL OK"
echo "  Models: $EXP_DIR/"
echo "=========================================="
