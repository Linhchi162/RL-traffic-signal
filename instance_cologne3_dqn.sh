#!/bin/bash
# instance_cologne3_dqn.sh
# Train DDQN tren Cologne3 voi luong xe trung binh 6 kich ban train (~1179 veh/hr)
# 8 seeds x 3 reward = 24 jobs (chay song song)
#
# Usage: cd /workspace/rl-traffic && bash instance_cologne3_dqn.sh
...
ROUTE="./nets/cologne3/cologne3_train.rou.xml"
EXP_DIR="./exp_cologne3"
LOG_DIR="./logs_cologne3_dqn"
STEPS=200000
SIM_DUR=100000
...
# Sinh route file training (0-100000s, ~1179 veh/hr) neu chua co
if [ ! -f "$ROUTE" ]; then
    echo "Generating training route file (~1179 veh/hr, 100000s)..."
...
echo ""
echo ">>> Launch 24 cologne3-DDQN jobs..."
...
OK=$((TOTAL - FAIL))
echo "=========================================="
echo "  cologne3-DDQN done: $OK/$TOTAL OK"
echo "  Models: $EXP_DIR/"
echo "=========================================="
