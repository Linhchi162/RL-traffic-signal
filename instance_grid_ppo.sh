#!/bin/bash
# instance_grid_ppo.sh — Train 24 grid-PPO jobs (8 seeds × 3 rewards) on one Vast.ai instance
# Multi-agent IPPO: 4 junctions, shared policy weights, MultiAgentVecEnv
...
TOTAL=${#ALL_PIDS[@]}
echo ""
echo "  $TOTAL grid-PPO jobs running. Logs: $LOG_DIR/"
echo ""
...
OK=$((TOTAL - FAIL))
echo "=========================================="
echo "  grid-PPO done: $OK/$TOTAL OK"
echo "=========================================="
