#!/bin/bash
# run_cologne8_real_eval.sh
# Danh gia DQN + DDQN + PPO tren Cologne8 luu luong that
# So sanh voi Random / Fixed-time / Webster baseline
#
# Chay sau khi instance_cologne8_real_all.sh hoan thanh.
# Usage: cd /workspace/rl-traffic && bash run_cologne8_real_eval.sh
...
echo "=== Cologne8 real-traffic evaluation ==="
echo "Workers : $WORKERS / $NCPU CPU"
echo "Models  : ./exp_cologne8_real"
